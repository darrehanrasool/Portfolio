...
const data = [
    ...
    {id: 3, link: 'www.youtube.com/@RehansCodePeaks', icon: <AiFillYoutube/>},
    ...
    {id: 7, link: 'https://leetcode.com/u/Darrehan/', icon: <SiLeetcode/>},
    {id: 8, link: 'https://www.facebook.com/', icon: <AiFillFacebook/>}
]
